...
type ClientInterface interface {
	...
	GetApiOrdersNumber(ctx context.Context, number string, reqEditors ...RequestEditorFn) (*http.Response, error)
}

func (c *Client) GetApiOrdersNumber(ctx context.Context, number string, reqEditors ...RequestEditorFn) (*http.Response, error) {
...
func NewGetApiOrdersNumberRequest(server string, number string) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	// GetApiOrdersNumberWithResponse request
	GetApiOrdersNumberWithResponse(ctx context.Context, number string, reqEditors ...RequestEditorFn) (*GetApiOrdersNumberResponse, error)
}

type GetApiOrdersNumberResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *AccrualOrderResponse
}
...
func (c *ClientWithResponses) GetApiOrdersNumberWithResponse(ctx context.Context, number string, reqEditors ...RequestEditorFn) (*GetApiOrdersNumberResponse, error) {
	rsp, err := c.GetApiOrdersNumber(ctx, number, reqEditors...)//nolint:bodyclose
	if err != nil {
		return nil, err
	}
